...
|---------|----------|-------------|
| GnuCOBOL | COBOL | Open source COBOL compiler | - selected
...
| OpenAI text-embedding-3-large | 3072 | Higher quality, higher cost |-> selected
| Voyage Code 2 | 1536 | Optimized for code |
| Cohere embed-english-v3 | 1024 | Good for English text |
| sentence-transformers (local) | varies | Free, runs locally | -> maybe fallback?
